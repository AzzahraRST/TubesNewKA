...
<body>
    ...
    <div class="container-fluid banner d-flex align-items-center">
        <div style="margin-left: 200px;" class="container text-left text-light">
            <h1 style="font-size: 47px; font-family: arial;"><strong>Pendaftaran Pegawai Desa Dawu, Kabupaten Ngawi</strong></h1>
            <button type="button" class="btn btn-primary" style="background-color: #633971;"><a class="link" style="text-decoration: none;" href="/recruitments/create">Daftar</a></button>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="content">
                        ...
                        <p align="justify" style="font-size: 20px;">
                           <strong> Balai Desa Dawu :</strong><br> 
                           Desa Dawu, yang terletak di Kecamatan Paron, Kabupaten Ngawi, Jawa Timur, adalah desa agraris dengan mayoritas penduduk bermata pencaharian sebagai petani dan pekebun, menghasilkan komoditas utama seperti padi dan jagung. Dengan lingkungan yang asri, tradisi gotong-royong yang kuat, serta infrastruktur yang terus berkembang, desa ini memiliki potensi besar di bidang pertanian, UMKM, dan agrowisata. Pemerintahan Desa Dawu juga berupaya meningkatkan pelayanan publik melalui inovasi digital, seperti pendataan penduduk berbasis website, guna mendukung pengelolaan data yang lebih efektif dan pembangunan desa yang mandiri serta sejahtera.<br>
                        </p>
                        <h3 style="font-size: 30px; color: #633971;">VISI & MISI</h3>
                        <p align="justify" style="font-size: 20px;">
                            <strong>VISI</strong><br>
                            "Senggigi Berseri"
(Bersih, Relegius, Sejahtera, Rapi, dan Indah)
"Terwujudnya masyarakat Desa Senggigi yang Bersih, Relegius, Sejahtra, Rapi dan Indah melalui Akselerasi Pembangunan yang berbasis Keagamaan, Budaya Hukum dan Berwawasan Lingkungan dengan berorentasi pada peningkatan Kinerja Aparatur dan Pemberdayaan Masyarakat"<br>
                            <strong>MISI</strong><br>
                            1. Pembangunan Jangka Panjang<br>
                            - Melanjutkan Pembangunan Desa yang belum terlaksana<br>
                            - Meningkatkan Kerjasama antara pemerintah Desa dengan Lembaga desa yang ada<br>
                            - Meningkatkan Kesejahtraan Masyarakat desa dengan meningkatkan sarana dan prasarana ekonomi warga.<br>
                            2. Pembangunan Jangka Pendek <br>
                            - Mengembangkan dan Menjaga serta melestarikan ada istiadat desa terutama yang telah mengakar di desa senggigi. <br>
                            - Meningkatkan pelayanan dalam bidang pemerintahan kepada warga masyarakat <br>
                            - Meningkatkan sarana dan prasarana ekonomi warga desa dengan perbaikan prasarana dan sarana ekonomi.<br>
                            - Meningkatkan sarana dan prasarana pendidikan guna peningkatan sumber daya manusia desa senggigi.<br>
                        </p>
                    </div>
                </div>
            </section>
...
</html><?php /**PATH /var/www/resources/views/rumah.blade.php ENDPATH**/ ?>